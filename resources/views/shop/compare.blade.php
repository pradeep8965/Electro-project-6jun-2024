                        ...
                        <tr>
                                ...
                                <a href="#" class="product d-block">
                                    <div class="product-compare-image">
                                        <div class="d-flex mb-3">
                                            <img class="img-fluid mx-auto" src="../../assets/img/212X200/img1.jpg"
                                                alt="Image Description">
                                        </div>
                                    </div>
                            ...
                            <td>
                                <a href="#" class="product">
                                    <div class="product-compare-image">
                                        <div class="d-flex mb-3">
                                            <img class="img-fluid mx-auto" src="../../assets/img/212X200/img6.jpg"
                                                alt="Image Description">
                                        </div>
                                    </div>
                                    <h3 class="product-item__title text-blue font-weight-bold mb-3">Purple NX Mini F1
                                        aparat SMART NX</h3>
                                </a>
                                <div class="text-warning mb-2">
                                    <small class="fas fa-star"></small>
                            ...
                            <td>
                                <a href="#" class="product">
                                    <div class="product-compare-image">
                                        <div class="d-flex mb-3">
                                            <img class="img-fluid mx-auto" src="../../assets/img/212X200/img7.jpg"
                                                alt="Image Description">
                                        </div>
                                    </div>
                            ...
                            <td>
                                <a href="#" class="product">
                                    <div class="product-compare-image">
                                        <div class="d-flex mb-3">
                                            <img class="img-fluid mx-auto" src="../../assets/img/212X200/img8.jpg"
                                                alt="Image Description">
                                        </div>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    ...
                                    <li><span class="">Enjoy advanced editing capabilities with the bundled Adobe
                                            Photoshop Lightroom 5 software.</span></li>
                                </ul>
                            </td>
                            <td>
                                <ul>
                                    <li><span class="">Pair and Play with your Bluetooth® device with 30' range</span>
                                    </li>
